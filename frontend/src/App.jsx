...
const TrashBinSolid = (props) => (
  ...
  >
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M8.6 2.6A2 2 0 0 1 10 2h4a2 2 0 0 1 2 2v2h3a1 1 0 1 1 0 2v12a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V8a1 1 0 0 1 0-2h3V4c0-.5.2-1 .6-1.4M10 6h4V4h-4zm1 4a1 1 0 1 0-2 0v8a1 1 0 1 0 2 0zm4 0a1 1 0 1 0-2 0v8a1 1 0 1 0 2 0z"
      clipRule="evenodd"
    ></path>
  </svg>
);
function App() {
  ...
  const handleToggleTask = async (t) => {
    ...
    setTasks(tasks.map((task) => (task.id === t.id ? updated : task)));
  };
  ...
  return (
    <>
      <div
        class={`min-h-screen flex flex-col items-center p-6 transition-colors duration-300 ${bgColor} ${textColor}`}
      >
        <div class="flex gap-6">
          <h1 class="text-3xl font-bold text-indigo-400 [text-shadow:0_0_8px_rgba(255,255,255,0.3)] mb-6">
            My Todo App
          </h1>
          <button
          ...
          {["all", "active", "completed"].map((f) => (
            <button
              ...
              class={`flex items-center justify-center px-3 py-1 rounded-lg border transition${
                filter === f
                  ? " text-gray-300"
                  : " text-gray-700 hover:bg-indigo-600/30 hover:shadow-md hover:shadow-indigo-500/30"
              }`}
            >
            ...
            {filteredTasks.map((t) => (
              <motion.li
                ...
                class={`flex justify-between items-center p-3 mb-2 rounded-lg border shadow-sm transition-all${
                  t.completed
                    ? theme === "dark"
                      ? " bg-green-700 text-gray-200 line-through opacity-70"
                      : " bg-green-200 text-gray-900 line-through opacity-70"
                    : theme === "dark"
                      ? "bg-gray-800 hover:bg-gray-800 text-gray-700"
              ...
              >
                ...
                <button onClick={() => handleDeleteTask(t.id)} class="ml-2">
